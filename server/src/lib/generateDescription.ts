...
export async function generateDescription(id: string, url: string, options: DescriptionOptions) {
	try {
		...
		// updateProgress(id, { step: DescriptionGenerationStep.UPLOADING, progress: 0 });
		...
		// // Wait for processing
		// updateProgress(id, { step: DescriptionGenerationStep.PROCESSING, progress: 0 });
		...
		// updateProgress(id, { step: DescriptionGenerationStep.GENERATING, progress: 0 });
		...
		// updateProgress(id, { step: DescriptionGenerationStep.COMPLETED, progress: 100 });
	} catch (error) {
